...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[
        ...
        box-highlight/.style={rectangle, draw, rounded corners, minimum width=2cm, minimum height=0.8cm, text width=1.9cm, align=center, draw=red!70, line width=1.2pt, fill=yellow!15, font=\footnotesize},
        arrow/.style={->, >=latex},
